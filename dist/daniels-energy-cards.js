...
const Hr = (s) => new wr(typeof s == "string" ? s : s + "", void 0, gt), M = (s, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ur, defineProperty: jr, getOwnPropertyDescriptor: Gr, getOwnPropertyNames: Kr, getOwnPropertySymbols: Vr, getPrototypeOf: qr } = Object, ze = globalThis, Lt = ze.trustedTypes, Yr = Lt ? Lt.emptyScript : "", Zr = ze.reactiveElementPolyfillSupport, de = (s, e) => s, Qe = { toAttribute(s, e) {
  switch (e) {
    case Boolean:
      s = s ? Yr : null;
      break;
  ...
  return t;
} }, xr = (s, e) => !Ur(s, e), Tt = { attribute: !0, type: String, converter: Qe, reflect: !1, useDefault: !1, hasChanged: xr };
...
let te = class extends HTMLElement {
  ...
  static createProperty(e, t = Tt) {
    if (t.state && (t.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(e) && ((t = Object.create(t)).wrapped = !0), this.elementProperties.set(e, t), !t.noAccessor) {
      ...
      i !== void 0 && jr(this.prototype, e, i);
    }
  }
  static getPropertyDescriptor(e, t, r) {
    const { get: i, set: o } = Gr(this.prototype, e) ?? { get() {
      return this[t];
    }, set(n) {
      this[t] = n;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(de("properties"))) {
      const t = this.properties, r = [...Kr(t), ...Vr(t)];
...
te.elementStyles = [], te.shadowRootOptions = { mode: "open" }, te[de("elementProperties")] = /* @__PURE__ */ new Map(), te[de("finalized")] = /* @__PURE__ */ new Map(), Zr?.({ ReactiveElement: te }), (ze.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ft = globalThis, At = (s) => s, $e = ft.trustedTypes, Mt = $e ? $e.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, yr = "$lit$", I = `lit$${Math.random().toFixed(9).slice(2)}$`, kr = "?" + I, Xr = `<${kr}>`, q = document, he = () => q.createComment(""), ue = (s) => s === null || typeof s != "object" && typeof s != "function", mt = Array.isArray, Jr = (s) => mt(s) || typeof s?.[Symbol.iterator] == "function", je = `[ 	
...
const Qr = (s, e) => {
  ...
  for (let c = 0; c < t; c++) {
    ...
    o += n === ae ? l + Xr : u >= 0 ? (r.push(p), l.slice(0, u) + yr + l.slice(u) + I + f) : l + I + (u === -2 ? c : f);
  }
...
class pe {
  constructor({ strings: e, _$litType$: t }, r) {
    ...
    this.parts = [];
    let o = 0, n = 0;
    const c = e.length - 1, l = this.parts, [p, h] = Qr(e, t);
    ...
    for (; (i = V.nextNode()) !== null && l.length < c; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const u of i.getAttributeNames()) if (u.endsWith(yr)) {
          ...
          l.push({ type: 1, index: o, name: w[2], strings: f, ctor: w[1] === "." ? ti : w[1] === "?" ? ri : w[1] === "@" ? ii : Ie }), i.removeAttribute(u);
...
class ei {
  ...
  u(e) {
    ...
    for (; l !== void 0; ) {
      if (n === l.index) {
        let p;
        l.type === 2 ? p = new ge(o, o.nextSibling, this, e) : l.type === 1 ? p = new l.ctor(o, l.name, l.strings, this, e) : l.type === 6 && (p = new si(o, this, e)), this._$AV.push(p), l = r[++c];
      }
...
class ge {
  ...
  _$AI(e, t = this) {
    e = se(this, e, t), ue(e) ? e === d || e == null || e === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : e !== this._$AH && e !== ie && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Jr(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    ...
    if (this._$AH?._$AD === i) this._$AH.p(t);
      ...
      const o = new ei(i, this), n = o.u(this.options);
...
const oi = ft.litHtmlPolyfillSupport;
oi?.(pe, ge), (ft.litHtmlVersions ??= []).push("3.3.3");
const ni = (s, e, t) => {
...
const ai = vt.litElementPolyfillSupport;
ai?.({ LitElement: O });
...
const di = /* @__PURE__ */ new Set(["unavailable", "unknown", "none", "null", ""]), hi = /^[a-z][a-z0-9_]*\.[a-z0-9_]+$/;
function v(s) {
  return typeof s == "string" && hi.test(s);
}
...
function L(s, e) {
  ...
  return di.has(r.toLowerCase()) ? null : r;
}
function W(s, e, t) {
...
const Lr = /* @__PURE__ */ new Set(["number", "input_number"]), fe = /* @__PURE__ */ new Set(["switch", "input_boolean"]), _e = /* @__PURE__ */ new Set(["select", "input_select"]), Tr = /* @__PURE__ */ new Set(["fan", "switch", "input_boolean"]), ui = /* @__PURE__ */ new Set(["on", "true", "1", "yes", "an", "ein"]);
function T(s) {
  const e = s.indexOf(".");
...
function wi(s, e, t) {
  ...
  return fe.has(i) ? F(s, r, ui.has((o ?? "").toLowerCase())) : Promise.reject(
...
function Se(s, e, t) {
  const r = xi[e], i = Ft(t?.warn, r.hotWarn), o = Ft(t?.alert, r.hotAlert);
...
const Rr = {
  ...
  heating: "Heizt",
  off: "Aus"
}, Ge = { min: 10, max: 80, step: 5 }, Ke = { min: 50, max: 100, step: 5 }, Ve = { min: 100, max: 2400, step: 50 }, Ht = 5, yi = 12, ki = 2, $i = 1, Si = 20, Ei = 1, Li = 300, Ti = 6e4, Ai = 3e4, Bt = 5, Ut = 10, jt = 48, Mi = 500, Ci = 8e3, Oi = /* @__PURE__ */ new Set([
  "not charging",
  "not discharging",
  "unknown",
  "unavailable",
...
function Ni(s) {
  ...
  return e === "standby" ? "idle" : e in Rr ? e : null;
}
function Wi(s) {
  const e = s.trim().toLowerCase();
...
const Ee = class Ee extends O {
  ...
  setConfig(e) {
    ...
    if (e.variant === "battery" && e.charge_mode_control !== void 0) {
      const t = bi(e.charge_mode_control);
   ...
   */
  getGridOptions() {
    const e = this._config?.variant === "thermal_group" ? $i + (this._config.items?.length ?? 0) : ki;
    return { columns: yi, rows: e, min_rows: e };
  }
  ...
  _idleThreshold(e) {
    ...
    return t.kind === "value" && t.value >= 0 ? t.value : Si;
  }
  ...
  _updatePowerAverage(e) {
    ...
    if (i === this._averageDirection) {
      ...
      const c = 1 - Math.exp(-n / Li);
      this._powerAverage += c * (t.value - this._powerAverage);
      return;
    }
    this._pendingDirection !== i && (this._pendingDirection = i, this._pendingSince = o), o - this._pendingSince >= Ai && this._commitAverage(i, t.value, o);
  }
  ...
  _timeRemaining(e, t) {
    ...
    if (i === void 0 && (i = r ? e.time_remaining_charging : e.time_remaining_discharging), i !== void 0) {
      ...
      return o.kind !== "value" ? { text: null, state: "device" } : Oi.has(o.value.trim().toLowerCase()) ? { text: null, state: "device" } : { text: o.value, state: "device" };
    }
  ...
  _estimateResult(e) {
    ...
    if (Date.now() - this._averageStartedAt < Ti)
  ...
  _chargeModeFromEntity(e) {
    ...
    return t.kind !== "value" ? null : vi(e, t.value) ? "off" : mi(e, t.value) ? "charge" : "auto";
  }
  /**
  ...
  _itemMode(e, t) {
    ...
    return i.kind === "value" ? Wi(i.value) : this._itemModeFromEntity(e) ?? "auto";
  }
  /**
    ...
    return a`
      <div class="header">
        ...
        <div class="badges">
          ...
          ${this._renderBadge(Rr[n], `status-${n}`)}
        </div>
      </div>
  ...
  _setItemMode(e, t) {
    ...
    if (i?.mode_entity) {
      ...
      this._holdOptimistic(`item:${e}`, o), this._write(
        Nt(this.hass, i.mode_entity, Ii[t]),
        () => {
...
`, Bi = /* @__PURE__ */ new Set([
  ...
  "alarm",
  "night"
]), Ui = 12.5, ji = 6.5, Gi = 6, Ki = 0.5, Vi = 500, qi = 40, Gt = 4, Yi = 12, Zi = ["L1", "L2", "L3"], Xi = {
  normal: {
...
const Ji = 2, Qi = 6e4, es = 2500, N = (s) => String(s).padStart(2, "0");
function ts(s) {
  const e = s.trim();
...
const Le = class Le extends O {
  ...
  _warnMinutes() {
    ...
    return typeof e == "number" && Number.isFinite(e) && e >= 0 ? e : Ji;
  }
  ...
  getGridOptions() {
    return { columns: Yi, rows: Gt, min_rows: Gt };
  }
  static getStubConfig() {
    return {
  ...
  get _kwpTotal() {
    return this._config?.kwp_total ?? Ui;
  }
  get _kwpString() {
    return [
      this._config?.kwp_pv1 ?? ji,
      this._config?.kwp_pv2 ?? Gi
    ];
  }
  // =========================================================================
  ...
  _demoView() {
    const e = this._config, t = Xi[e.demo_state ?? "normal"];
    return {
  ...
  _imbalance(e, t) {
    ...
    const i = r?.imbalance_ratio ?? Ki, o = r?.imbalance_min_w ?? Vi, n = (c, l) => c < i * l && l > o;
    return [n(e, t), n(t, e)];
  }
  // =========================================================================
  // render
   ...
   */
  _renderExportBar(e) {
    const t = e.exportW, r = t !== null && t >= qi, i = this._kwpTotal * 1e3, o = r && i > 0 ? b(t / i * 100, 0, 100) : 0;
    return a`
      <div class="string-row">
  ...
  _renderPhasesTable(e) {
    ...
    return a`
      ...
      const l = r[c];
      return a`
            <span class="row-label">${Zi[c]}</span>
...
const ss = /* @__PURE__ */ new Set([
  ...
  "night",
  "export"
]), Kt = 4, os = 4, ns = 12, as = "sensor.pv_helper_solar_direkt_leistung", ls = "sensor.pv_helper_speicher_leistung", cs = "sensor.inverter_external_power", Vt = "sensor.pv_helper_energie_solar_direkt", qt = "sensor.pv_helper_energie_entladen_gesamt", Yt = "sensor.pv_helper_energie_import_gesamt", Zt = "var(--success-color)", Xt = "#378ADD", Jt = "#E24B4A", ds = ["day", "week", "month", "year"], hs = {
  day: "Tag",
  week: "Woche",
  month: "Monat",
  year: "Jahr"
}, us = 180, ps = 2, _s = ["_apexChart", "apexChart", "_chart"], gs = {
...
const Te = class Te extends O {
  ...
  setConfig(e) {
    ...
    if (e.demo_state && !ss.has(e.demo_state))
      throw new Error(
  ...
  getGridOptions() {
    return { columns: ns, rows: Kt, min_rows: os };
  }
  static getStubConfig() {
    return {
  ...
  _rawInputs() {
    if (!this._entityMode)
      return gs[this._config.demo_state ?? "normal"];
    const e = this._config;
    return {
  ...
  _availablePeriods() {
    return this._energyPeriodsAvailable() ? [...ds] : ["day"];
  }
  _effectivePeriod(e) {
  ...
  _apexCardConfig(e) {
    const t = this._config, o = {
      chart: { height: this._chartHeight ?? us, stacked: !0 },
    ...
    return e === "day" ? {
      ...
      series: [
        {
          entity: this._chartEntity(t?.solar_power_entity, as),
          name: "Solar",
          color: Zt
        },
        {
          entity: this._chartEntity(t?.storage_power_entity, ls),
          name: "Speicher",
          color: Xt,
          transform: "return Math.max(0, x);"
        },
        {
          entity: this._chartEntity(t?.grid_power_entity, cs),
          name: "Netz",
          color: Jt,
          transform: "return Math.max(0, x);"
        }
  ...
  _applyChartHeight() {
    ...
    t <= 0 || this._chartHeight !== void 0 && Math.abs(t - this._chartHeight) <= ps || (this._chartHeight = t, this._resizeApex(t));
  }
  _resizeApex(e) {
...
let ot = Te;
const ke = ["day", "week", "month", "year"], ms = new Set(ke), Qt = 4, vs = 12, bs = {
  day: "Tag",
  week: "Woche",
  month: "Monat",
  year: "Jahr"
...
function zr(s) {
  return Array.isArray(s) ? s.some(zr) : typeof s == "number" ? Number.isFinite(s) : typeof s == "string" && s.trim().length > 0;
}
const Ae = class Ae extends O {
  ...
  setConfig(e) {
    ...
    if (e.default_period && !ms.has(e.default_period))
      throw new Error(
  ...
  /** HA sections view: a third of the section, fixed height. */
  getGridOptions() {
    return { columns: vs, rows: Qt, min_rows: Qt };
  }
  static getStubConfig() {
  ...
  get _entityMode() {
    ...
    return e ? ke.some((t) => {
      const r = e[t];
      return r !== void 0 && Q.some((i) => zr(r[i.key]));
    }) : !1;
  }
  /**
  ...
  _periodValues(e) {
    if (!this._entityMode) return ws[e];
...
let nt = Ae;
const at = ["day", "week", "month", "year"], xs = new Set(at), ys = {
  day: "Tag",
  week: "Woche",
  month: "Monat",
  year: "Jahr"
}, er = 4, ks = 3, $s = 24, Ss = 220, Es = 2, Ls = ["_apexChart", "apexChart", "_chart"], Me = class Me extends O {
  constructor() {
  ...
  setConfig(e) {
    ...
    if (e.default_period && !xs.has(e.default_period))
      throw new Error(
  ...
  getGridOptions() {
    return { columns: $s, rows: er, min_rows: ks };
  }
  static getStubConfig() {
  ...
  _label(e) {
    ...
    return typeof t == "string" && t.trim().length > 0 ? t : ys[e];
  }
...
let lt = Me;
const Ts = 12, tr = 5, As = 4, rr = 30, ir = 80, sr = 5, Ms = 24, or = "Luftentfeuchter", Cs = "cancel", Os = /* @__PURE__ */ new Set(["cancel", "abbrechen"]), Ps = 300, Ds = 8e3, Rs = 300 * 1e3, zs = { top: 6, right: 8, bottom: 18, left: 30 }, K = 10, Ye = 20, nr = 6, ar = 2;
function le(s) {
...
const Ce = class Ce extends O {
  ...
  getGridOptions() {
    return { columns: Ts, rows: tr, min_rows: As };
  }
  static getStubConfig() {
    return {
  ...
  _renderChartSvg(e, t, r) {
    const { top: i, right: o, bottom: n, left: c } = zs, l = Math.max(1, e - c - o), p = Math.max(1, t - i - n), { lo: h, hi: u } = this._yBounds(r), g = u - h || 1, f = (S) => i + p * (1 - (S - h) / g), w = Date.now(), $ = w - this._historyHours() * 3600 * 1e3, y = w - $ || 1, z = (S) => c + l * b((S - $) / y, 0, 1), wt = [];
    ...
    const We = [], xt = i + p + 13, Fe = 3600 * 1e3, Wr = nr * Fe, J = new Date($);
    for (J.setMinutes(0, 0, 0); J.getTime() < $ || J.getHours() % nr !== 0; )
      J.setTime(J.getTime() + Fe);
    let yt = !0;
    for (let S = J.getTime(); S < w - 40 * Fe / 60; S += Wr) {
      const B = yt ? "start" : "middle";
      yt = !1, We.push(j`
        <text class="axis-label" x=${z(S)} y=${xt} text-anchor=${B}>${Is(new Date(S))}</text>
      `);
    }
    We.push(j`
    ...
    if (ne.length > 0) {
      ...
      He = `M${S.join(" L")}`;
      const B = z(ne[0].t).toFixed(1), Fr = z(ne[ne.length - 1].t).toFixed(1), kt = (i + p).toFixed(1);
      Be = `M${B},${kt} L${S.join(" L")} L${Fr},${kt} Z`;
    }
...
const Fs = {
  ...
  amber: "pill-amber",
  gray: "pill-gray"
}, Hs = 12, cr = 3, Bs = 3, dr = "Rollläden", hr = 6, Us = 300, js = 8e3, Gs = 100, Xe = { entity: "cover.__demo_group__", position: 65 }, Ks = [
  {
    name: "Erdgeschoss",
    covers: [
  ...
  getGridOptions() {
    return { columns: Hs, rows: cr, min_rows: Bs };
  }
  static getStubConfig() {
        ...
        <div class="card">
          <div class="header">
            ...
            <div class="head-right">
              <div class="badges">
                ${l.map(
      (h) => a`<span class="badge ${Fs[h.color ?? "blue"]}">
  ...
  _onPosChange(e, t) {
    ...
    i !== void 0 && window.clearTimeout(i), this._writeTimers.set(
      e,
      window.setTimeout(() => {
        this._writeTimers.delete(e), this._holdOptimistic(e, () => this._clearPosLocal(e)), this._write(fi(this.hass, e, r), () => {
  ...
  _cover(e, t) {
    this._isDemo || !Wt(e) || this._write(gi(this.hass, e, t), () => {
    });
  }
  _onScene(e, t) {
    this._flashScene = t, window.setTimeout(() => {
      this._flashScene === t && (this._flashScene = null);
    }, Gs), this._write(Cr(this.hass, e.action), () => {
    });
  }
  _holdOptimistic(e, t) {
    this._clearSettle(e), this._settleTimers.set(
...
let dt = Oe;
const Vs = 12, ur = 3, qs = 2, Ys = "Licht", Zs = 300, Xs = 8e3, Js = [
  ...
  getGridOptions() {
    return { columns: Vs, rows: ur, min_rows: qs };
  }
  static getStubConfig() {
  ...
  render() {
    ...
    return a`
      <ha-card>
        <div class="card">
          <div class="header">
            <span class="name">${e.name ?? Ys}</span>
...
let ht = Pe;
const Qs = 12, pr = 3, eo = 3, _r = "Bett", gr = {
  seiten: "Seiten",
...
function ro(s) {
  return s.colorMode === "white" ? Ir(s.kelvin) : Nr(s.hue, s.sat);
}
function io() {
...
const De = class De extends O {
  constructor() {
    super(), this._closer = new X(this, () => this._collapse()), this._expanded = !1, this._model = io(), this._editRow = "seiten", this._editMode = "ambiente";
  }
  setConfig(e) {
    if (!e)
  ...
  getGridOptions() {
    return { columns: Qs, rows: pr, min_rows: eo };
  }
  static getStubConfig() {
  ...
  render() {
    const e = this._config;
    if (!e) return d;
    const t = this._rowKeys().map((i) => to(i, this._model[i].active)).filter((i) => i !== null), r = t.length > 0 ? t.join(" · ") : "Alles aus";
    return a`
      <ha-card>
        <div class="card">
          <div class="header">
  ...
  _renderRow(e) {
    const t = this._model[e], r = t.active, i = r === "off" ? null : ro(t.modes[r]);
    return a`
      <div class="bed-row">
        <span
  ...
  _renderEditor() {
    ...
    return a`
      ...
      (n, c) => a`<button
              ...
              style="background:${n.kind === "white" ? Ir(n.kelvin ?? 4e3) : Nr(n.hue ?? 0, n.sat ?? 100)}"
              title=${n.name}
              aria-label=${n.name}
...
const so = {
  ...
  amber: "pill-amber",
  gray: "pill-gray"
}, oo = 12, mr = 4, no = 3, vr = "Garage", ao = 2, lo = 8e3, co = 900 * 1e3, ho = ["day", "week", "month", "year"], uo = {
  day: "Tag",
  week: "Woche",
  month: "Monat",
  year: "Jahr"
...
], _o = { day: 1, week: 6, month: 25, year: 300 }, Re = class Re extends O {
  constructor() {
  ...
  getGridOptions() {
    return { columns: oo, rows: mr, min_rows: no };
  }
  static getStubConfig() {
  ...
  get _threshold() {
    ...
    return typeof e == "number" && e >= 0 ? e : ao;
  }
  _on(e) {
    const t = this._onLocal[e];
    if (t !== void 0) return t;
  ...
  _consumption(e) {
    if (this._isDemo) {
      ...
      return Number((r * _o[this._period]).toFixed(2));
    }
...
console.info(
  `%c DANIELS-HOME-ASSISTANT-CARDS %c v${go} `,
