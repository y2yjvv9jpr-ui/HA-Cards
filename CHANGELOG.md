...
- **des-dehumidifier-card:** Die An/Aus-Segmente von **Gerät** und
  **Kindersicherung** nutzen jetzt die gemeinsame Reihenfolge **Aus links, An
  rechts** (`ON_OFF_OPTIONS`). Nur Reihenfolge, kein Verhaltens-/Service-Wechsel.

## [0.17.3]

### Geändert

- **des-garage-card:** Die An/Aus-Segmente in der **Tabelle** (Licht + Geräte)
  und im **Einstellungen**-Block nutzen jetzt die gemeinsame Reihenfolge
  **Aus links, An rechts** (`ON_OFF_OPTIONS`). Nur Reihenfolge, kein
